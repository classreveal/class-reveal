...
def edit():
    if request.method == "POST":
        ...
        return redirect(url_for("home"))
    district = "json/wwp.json" if current_user.district == 0 else "json/br.json"
    return render_template("edit.html", schedule=current_user.schedule.get(), district=district)
